...
"tempera_sliderimg1"	=> esc_url( get_template_directory_uri() )."/images/slider/tempera-slide1.jpg",
...
"tempera_sliderlink1"	=> "",
"tempera_sliderimg2"	=> esc_url( get_template_directory_uri() )."/images/slider/tempera-slide2.jpg",
...
"tempera_sliderlink2"	=> "",
"tempera_sliderimg3"	=> esc_url( get_template_directory_uri() )."/images/slider/tempera-slide3.jpg",
...
"tempera_sliderlink3"	=> "",
"tempera_sliderimg4"	=>  esc_url( get_template_directory_uri() )."/images/slider/tempera-slide4.jpg",
...
"tempera_sliderlink4"	=> "",
"tempera_sliderimg5"	=>  esc_url( get_template_directory_uri() )."/images/slider/tempera-slide5.jpg",
...
"tempera_comoff"	=> "Show",
"tempera_comlabels" => 0, // 0 = placeholders, 1 = labels
...
$tempera_column_defaults= array(
	$tempera_column_content[] = array (
        'image'	=> esc_url( get_template_directory_uri() )."/images/columns/tempera-column1.jpg",
    ...
    $tempera_column_content[] = array (
        'image'	=> esc_url( get_template_directory_uri() )."/images/columns/tempera-column2.jpg",
        'title'	=> 'Responsive',
	...
	$tempera_column_content[] = array (
        'image'	=> esc_url( get_template_directory_uri() )."/images/columns/tempera-column3.jpg",
        'title'	=> 'Endless Fonts ',
    ...
    $tempera_column_content[] = array (
        'image'	=> esc_url( get_template_directory_uri() )."/images/columns/tempera-column4.jpg",
    ...
    $tempera_column_content[] = array (
        'image'	=> esc_url( get_template_directory_uri() )."/images/columns/tempera-column5.jpg",
    ...
    $tempera_column_content[] = array (
        'image'	=> esc_url( get_template_directory_uri() )."/images/columns/tempera-column6.jpg",
