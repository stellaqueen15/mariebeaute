...
if ( ! function_exists( 'catchresponsive_setup' ) ) :
	...
	function catchresponsive_setup() {
		...
		add_image_size( 'catchresponsive-featured-content', 350, 197, true ); // used in Featured Content and Portfolio Ratio 16:9

		add_image_size( 'catchresponsive-hero', 528, 297, true ); // used in Hero Content
		...
		add_image_size( 'catchresponsive-sm-square', 100, 100, true ); // used in Testimonials and Services Ratio 1:1

		add_image_size( 'catchresponsive-stats', 40, 40, true ); // used in Stats Ratio 1:1
		...
		add_theme_support(
			...
			array(
				array(
					'name'      => esc_html__( 'Extra small', 'catch-responsive' ),
					'shortName' => esc_html__( 'XSS', 'catch-responsive' ),
					'size'      => 13,
					'slug'      => 'extra-small',
				),
				array(
					'name'      => esc_html__( 'Small', 'catch-responsive' ),
					'shortName' => esc_html__( 'S', 'catch-responsive' ),
					'size'      => 14,
					'slug'      => 'small',
				),
				array(
					'name'      => esc_html__( 'Normal', 'catch-responsive' ),
					'shortName' => esc_html__( 'M', 'catch-responsive' ),
					'size'      => 16,
					'slug'      => 'normal',
				),
				array(
					'name'      => esc_html__( 'Large', 'catch-responsive' ),
					'shortName' => esc_html__( 'L', 'catch-responsive' ),
					'size'      => 26,
					'slug'      => 'large',
				),
				array(
					'name'      => esc_html__( 'Huge', 'catch-responsive' ),
					'shortName' => esc_html__( 'XL', 'catch-responsive' ),
					'size'      => 32,
					'slug'      => 'huge',
				),
			)
		...
		add_theme_support( 'editor-color-palette', array(
			array(
				'name'  => esc_html__( 'White', 'catch-responsive' ),
				'slug'  => 'white',
				'color' => '#ffffff',
			),
			array(
				'name'  => esc_html__( 'Black', 'catch-responsive' ),
				'slug'  => 'black',
				'color' => '#000000',
			),
			array(
				'name'  => esc_html__( 'Dark Gray', 'catch-responsive' ),
				'slug'  => 'dark-gray',
				'color' => '#404040',
			),
			array(
				'name'  => esc_html__( 'Gray', 'catch-responsive' ),
				'slug'  => 'gray',
				'color' => '#eeeeee',
			),
			array(
				'name'  => esc_html__( 'Light Gray', 'catch-responsive' ),
				'slug'  => 'light-gray',
				'color' => '#f9f9f9',
			),
			array(
				'name'  => esc_html__( 'Yellow', 'catch-responsive' ),
				'slug'  => 'yellow',
				'color' => '#e5ae4a',
			),
			array(
				'name'  => esc_html__( 'Blue', 'catch-responsive' ),
				'slug'  => 'blue',
				'color' => '#1b8be0',
			),
			array(
				'name'  => esc_html__( 'Tahiti Gold', 'catch-responsive' ),
				'slug'  => 'tahiti-gold',
				'color' => '#e4741f',
			),
		) );
...
if ( ! function_exists( 'catchresponsive_fonts_url' ) ) :
...
function catchresponsive_scripts() {
	...
	wp_enqueue_style( 'catchresponsive-block-style', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'css/blocks.css', array( 'catchresponsive-style' ), CATCHRESPONSIVE_THEME_VERSION );
	...
	$enable_fitvids = $options['enable_fitvids'];
 ...
 *
 * @since Catch responsive 2.7.9
 */
function catchresponsive_block_editor_styles() {
	// Block styles.
	wp_enqueue_style( 'catchresponsive-block-editor-style', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'css/editor-blocks.css' );

	// Add custom fonts.
	wp_enqueue_style( 'catchresponsive-fonts', catchresponsive_fonts_url(), array(), null );
}
add_action( 'enqueue_block_editor_assets', 'catchresponsive_block_editor_styles' );
...
if ( ! function_exists( 'catchresponsive_page_post_meta' ) ) :
	...
	function catchresponsive_page_post_meta() {
	    ...
	    $catchresponsive_page_post_meta .= '<span class="post-author">' . __( 'By', 'catch-responsive' ) . ' <span class="author vcard"><a class="url fn n" href="' . esc_url( $catchresponsive_author_url ) . '" title="View all posts by ' . esc_attr( get_the_author() ) . '" rel="author">' . esc_html( get_the_author() ) . '</a></span>';
