...
/** One Item in Tax Section of Details */
class TaxItem {
    ...
    public static function from_json( array $item_json ): TaxItem {
        return new TaxItem( $item_json['id'], $item_json['title'], Formula::from_json( $item_json['formula'] ), Decimal::from_number( $item_json['amount'] ) );
    }
